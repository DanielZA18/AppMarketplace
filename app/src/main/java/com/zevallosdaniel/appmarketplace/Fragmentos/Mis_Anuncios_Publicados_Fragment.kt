...
import com.zevallosdaniel.appmarketplace.databinding.FragmentMisAnunciosPublicadosBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.IbLimpiar.setOnClickListener {
            ...
            if( consulta.isNotEmpty()){
                ...
                Toast.makeText(context, "No se ha ignresado una consulta", Toast.LENGTH_SHORT).show()
            }
        }
