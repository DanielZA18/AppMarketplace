...
object Constantes {
    ...
    val categoriasIcono = arrayOf(
        ...
        R.drawable.ic_categoria_exclusivos,
    ...
    //Esta clase nos va a servir para definir las funciones que se usará a lo largo del proyecto
    ...
    fun mapaIntent(context: Context, latitud : Double, longitud : Double){
        ...
        if(mapIntent.resolveActivity(context.packageManager)!=null){
            //La app de Google maps sí está instalada
            context.startActivity(mapIntent)
        }else{
            //Si la app de google maps no está instalada
            Toast.makeText(context, "No tienes instalada la aplicación de Google Maps", Toast.LENGTH_SHORT).show()
        }
    }
