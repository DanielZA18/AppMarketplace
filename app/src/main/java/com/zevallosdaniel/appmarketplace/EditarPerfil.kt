...
import com.zevallosdaniel.appmarketplace.databinding.ActivityEditarPerfilBinding
...
class EditarPerfil : AppCompatActivity() {
    ...
    private fun validarInfo() {
        ...
        if(nombres.isEmpty()){
            ...
            Toast.makeText(this, "Seleccione un teléfono", Toast.LENGTH_SHORT).show()
        } else {
            actualizarInfo()
        }
    }
    ...
    private val concederPermisoAlmacenamiento =
            registerForActivityResult(ActivityResultContracts.RequestPermission()){ esConcedido ->
                if(esConcedido){
                    ...
                    Toast.makeText(
                        this,
                        "El permiso almacenamiento ha sido denegada",
                        Toast.LENGTH_SHORT
                    ).show()
                }
            }
