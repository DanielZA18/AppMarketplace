...
import com.zevallosdaniel.appmarketplace.Opciones_login.Login_email
import com.zevallosdaniel.appmarketplace.databinding.ActivityOpcionesLoginBinding
...
class OpcionesLogin : AppCompatActivity() {
    ...
    private fun autenticacionGoogle(idToken: String?) {
        val credendial = GoogleAuthProvider.getCredential(idToken, null)
        firebaseAuth.signInWithCredential(credendial)
