package com.zevallosdaniel.appmarketplace.Anuncios
...
import com.zevallosdaniel.appmarketplace.Adaptadores.AdaptadorImagenSeleccionada
...
import com.zevallosdaniel.appmarketplace.SeleccionarUbicacion
import com.zevallosdaniel.appmarketplace.databinding.ActivityCrearAnuncioBinding
...
class CrearAnuncio : AppCompatActivity() {
        ...
        ref.child(idAnuncioEditar)
            .addListenerForSingleValueEvent(object : ValueEventListener{
                override fun onDataChange(snapshot: DataSnapshot) {
                    /*Obtener de la BD de la información del anuncio */
                    ...
                    /*Setear la información de las vistas */
                ...
                storageReference.putFile(modeloImagenSel.imagenUri!!)
                    .addOnSuccessListener { taskSnaphot ->
                        ...
                        if(Edicion){
                            ...
                            progressDialog.dismiss()
                            Toast.makeText(this, "Se publicó su anuncio",
                                Toast.LENGTH_SHORT).show()
                            limpiarCampos()
                        }
                    }
    ...
    private val solicitarPermisoAlmacenamiento = registerForActivityResult(
        ...
        if(esConcedido){
            ...
            Toast.makeText(this, "El permiso de almacenamiento ha sido denegado",
                Toast.LENGTH_SHORT).show()
        }
    }
    ...
    private val resultadoGaleria_ARL =
        registerForActivityResult(ActivityResultContracts.StartActivityForResult()){ resultado ->
            if(resultado.resultCode == Activity.RESULT_OK){
                ...
                val tiempo = "${Constantes.obtenerTiempoDis()}"
                val modeloImgSeleccionada = ModeloImageSeleccionada(
    ...
    private val solicitarPermisoCamara = registerForActivityResult(
        ...
        if(todosConcedidos){
            ...
            Toast.makeText(this, "El permiso de la cámara o almacenamiento ha sido denegada, o ambas fueron denegadas",
                Toast.LENGTH_SHORT).show()
        }

    }

    private fun imageCámara() {
