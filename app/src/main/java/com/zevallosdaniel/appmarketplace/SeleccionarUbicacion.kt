...
import com.zevallosdaniel.appmarketplace.databinding.ActivitySeleccionarUbicacionBinding
...
class SeleccionarUbicacion : AppCompatActivity() , OnMapReadyCallback {
    ...
    private var mFusedLocationProviderCliente : FusedLocationProviderClient?=null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mFusedLocationProviderCliente = LocationServices.getFusedLocationProviderClient(this)
    ...
    private fun detectAndShowDeviceLocationMap(){
         ...
         try {
            val locationResult = mFusedLocationProviderCliente!!.lastLocation
    ...
    private fun esGpsActivado(): Boolean {
        ...
        return !(!gpsEnable && !networkEnabled)
    }

    @SuppressLint("MissingPermission")
    private val solicitarPermisolocacion : ActivityResultLauncher<String> = registerForActivityResult(ActivityResultContracts.RequestPermission()){ seConcede ->
        if (seConcede){
